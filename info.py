...
# Bot information
SESSION = environ.get('SESSION', 'Media_search')API_ID = int(environ.get('API_ID', '4878337'))
API_HASH = environ.get('API_HASH', '50fcfb6bfad2fd47040a42eb6a1f07fc')BOT_TOKEN = environ.get('BOT_TOKEN', '5084653952:AAEOT0k_1yED49nQpMSUjeA-yVokT8eemf8')
# Bot settings
...
auth_channel = environ.get('-1001578596144')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001226419845')).split()]
